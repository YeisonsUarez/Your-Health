...
public class Medico extends Usuario implements Serializable {
    ...
    private ArrayList<String> areasDeTrabajo;
    ...
    public Medico(String idUsuario, String aniosExperiencia, ArrayList<String> areasDeTrabajo, ArrayList<CitaMedica> citasRealizadas, ArrayList<FormulaMedica> formulasDadas, String descripcion) {
    ...
    public ArrayList<String> getAreasDeTrabajo() {
        return areasDeTrabajo;
    }

    public void setAreasDeTrabajo(ArrayList<String> areasDeTrabajo) {
        this.areasDeTrabajo = areasDeTrabajo;
    }
